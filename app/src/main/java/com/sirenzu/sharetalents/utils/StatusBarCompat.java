...
/**
 * Created by Yuanyx on 15/9/21.
 */
public class StatusBarCompat {
    private static final int INVALID_VAL = -1;
    private static final int COLOR_DEFAULT = Color.parseColor("#00c5cd");

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public static void compat(AppBaseActivity activity, int statusColor){
