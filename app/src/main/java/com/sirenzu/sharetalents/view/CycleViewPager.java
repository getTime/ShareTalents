...
import com.sirenzu.sharetalents.utils.GlideUtil;
...
public class CycleViewPager extends FrameLayout
    ...
    private List<CycleInfo> infos;//数据集合
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.view_cycle, this, true);
...
//        backGround.setBackgroundResource(R.color.half_transparency);
